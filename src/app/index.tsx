...
export default function HomeScreen() {
  ...
  const duplicatedSubjects = useMemo(
    () => [...subjectsData, ...subjectsData, ...subjectsData],
    [],
  );
      ...
      >
        ...
        <Animated.View entering={FadeInUp.duration(500)} style={styles.section}>
          ...
          <FlatList
            ...
            contentContainerStyle={[
              ...
              { paddingLeft: dimensions.screenPaddingHorizontal - 8 },
            ]}
        ...
        <Animated.View entering={FadeInUp.duration(550)} style={styles.section}>
          <SectionHeader
            ...
            subtitle="Short lessons to stay on track"
        ...
        <Animated.View entering={FadeInUp.duration(600)} style={styles.section}>
          <MasonrySection
            ...
            data={pastPapersData.map((p) => ({
              ...
              height: p.title.toLowerCase().includes("uneb")
                ? 220
...
const PromotionBanner = () => (
  <View style={[styles.banner, { backgroundColor: "#FBE7CD" }]}>
    ...
    <Text style={styles.bannerSubtitle}>
      Access to curated books and revision resources for every subject.
    </Text>
    <Pressable
      style={styles.bookshopButton}
