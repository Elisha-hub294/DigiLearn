...
const trending: VideoLesson[] = [
  {
    id: "quadratic",
    title: "Mastering Quadratic Equations | Complete Revision Lesson",
    subject: "Mathematics",
    teacher: "Tr. Elisha",
    uploadedAt: "2 months ago",
    duration: "12:58",
    thumbnail: require("../../assets/images/thumb-1.jpeg"),
    avatar: require("../../assets/images/tr-1.webp"),
  },
  {
    id: "bonding",
    ...
    duration: "08:45",
    thumbnail: require("../../assets/images/thumb-2.jpeg"),
    avatar: require("../../assets/images/tr-default.png"),
    isNew: true,
  },
  {
    id: "writing",
    ...
    duration: "21:17",
    thumbnail: require("../../assets/images/thumb-3.jpg"),
    avatar: require("../../assets/images/tr-2.jpg"),
  },
];
const latest: VideoLesson[] = [
  ...trending,
  {
    ...
    duration: "14:20",
    thumbnail: require("../../assets/images/thumb-4.jpeg"),
    avatar: require("../../assets/images/tr-3.jpg"),
    isNew: true,
  },
  {
    id: "circuits",
    ...
    duration: "18:32",
    thumbnail: require("../../assets/images/thumb-5.jpeg"),
    avatar: require("../../assets/images/tr-1.webp"),
    isNew: true,
  },
  {
...
export default function VideosScreen() {
  ...
  const visibleLatest = useMemo(
    () =>
      subject === "All" ? latest : latest.filter((_, index) => index % 2 === 0),
    [subject],
  );
    ...
    () => (
      <>
        ...
        <View style={styles.section}>
          ...
          <TrendingCarousel items={trending} cardWidth={cardWidth} />
        </View>
